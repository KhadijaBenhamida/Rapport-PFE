...
\begin{figure}[!htbp]
  ...
  \caption{Sochaux Plantis of Stellantis}
...
\begin{tabularx}{\textwidth}{|>{\columncolor[HTML]{E6F2FF}[\tabcolsep][\tabcolsep]}X|>{\columncolor[HTML]{F5F5F5}[\tabcolsep][\tabcolsep]}X|>{\columncolor[HTML]{F0F8F0}[\tabcolsep][\tabcolsep]}X|}
\hline
\textcolor[HTML]{003D99}{\textbf{Role}} & \textcolor[HTML]{333333}{\textbf{Responsibilities}} & \textcolor[HTML]{006600}{\textbf{Interactions \& Data Sources}} \\
\hline
...
\begin{tabularx}{\textwidth}{|>{\columncolor[HTML]{E6F2FF}[\tabcolsep][\tabcolsep]}X|>{\columncolor[HTML]{E6F2FF}[\tabcolsep][\tabcolsep]}X|>{\columncolor[HTML]{E6F2FF}[\tabcolsep][\tabcolsep]}X|}
\hline
\textcolor[HTML]{003D99}{\textbf{Gate 1}} & \textcolor[HTML]{003D99}{\textbf{Gate 2}} & \textcolor[HTML]{003D99}{\textbf{Gate 3}} \\
\hline
...
\begin{tabularx}{\textwidth}{|>{\columncolor[HTML]{FFF4E6}[\tabcolsep][\tabcolsep]}X|>{\columncolor[HTML]{F0F8F0}[\tabcolsep][\tabcolsep]}X|}
\hline
\textcolor[HTML]{CC6600}{\textbf{Challenge}} & \textcolor[HTML]{006600}{\textbf{LEON Contribution}} \\
\hline
...
\begin{tabularx}{\textwidth}{|>{\columncolor[HTML]{E8F4F8}[\tabcolsep][\tabcolsep]}X|>{\columncolor[HTML]{F5F5F5}[\tabcolsep][\tabcolsep]}X|>{\columncolor[HTML]{FFE8E8}[\tabcolsep][\tabcolsep]}X|}
\hline
\textcolor[HTML]{003D99}{\textbf{Question Needed}} & \textcolor[HTML]{333333}{\textbf{Current Process}} & \textcolor[HTML]{CC0000}{\textbf{Barriers}} \\
\hline
...
\begin{enumerate}
  ...
  \\\\
  \textbf{Success criterion:} System correctly resolves receivers from directory (AAD), allows preview and tracks all messages, keeps audit trail for communications.
  \vspace{0.3cm}
